...
var COUNTRY_PARM = "&&certification_country=IN&certification.lte=U";
//var BOX_OFFICE_FEED = "https://api.themoviedb.org/3/movie/now_playing?api_key=" + API_KEY + COUNTRY_PARM;
var BOX_OFFICE_FEED = "https://api.themoviedb.org/3/discover/movie?api_key="+ API_KEY + COUNTRY_PARM
 //var UPCOMING_FEED = "https://api.themoviedb.org/3/movie/upcoming?api_key=" + API_KEY + COUNTRY_PARM;
 var UPCOMING_FEED = "https://api.themoviedb.org/3/discover/movie?language=en&media_type=movie&vote_count.gte=0&list_style=1&primary_release_year=2016&sort_by=primary_release_date.desc&api_key=dbf71473cf25bbd06939baef47b626eb";
// var UPCOMING_FEED = "https://api.themoviedb.org/3/discover/movie?api_key="+ API_KEY + COUNTRY_PARM;
var TOP_RATED_FEED = "https://api.themoviedb.org/3/movie/top_rated?api_key=" + API_KEY;
// var TOP_RATED_FEED = "https://api.themoviedb.org/3/discover/movie?api_key="+ API_KEY + COUNTRY_PARM;
// var POPULAR_FEED = "https://api.themoviedb.org/3/movie/popular?api_key=" + API_KEY + COUNTRY_PARM;
var POPULAR_FEED = "https://api.themoviedb.org/3/discover/movie?api_key="+ API_KEY + COUNTRY_PARM;
    ...
    loadLatestBoxOfficeMovies: {
        value: function () {
            ...
            .then(function (response) {
                 ...
                 function SortByLanguage(x,y) {
                          return ((x.original_language == y.original_language) ? 0 : ((x.original_language > y.original_language) ? 1 : -1 ));
                      }

                  var result = response.results.filter(function(element){
                    if (element.poster_path != null && element.original_language !='en' && element.original_language !='hi'){
                ...
                return  result.sort(SortByLanguage);
